...
cd receiver 
sed -i "/#define ETH/c\\$eth" decodemod.c
sed -i "/#define DST_IP/c\\$dstip" decodemod.c
sed -i "/#define SRC_IP/c\\$srcip" decodemod.c
sed -i "/unsigned char SMAC[ETH_ALEN]/c\\$smac" decodemod.c
sed -i "/unsigned char DMAC[ETH_ALEN]/c\\$smac" decodemod.c
